...
## Executive Summary
- **274** modern state checks (`statecheck.ExpectKnownValue`)
- **46** modern plan checks (`plancheck.Expect*`)
...
- **60/111** optional fields are tested
