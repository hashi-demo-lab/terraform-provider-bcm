...
work on $ARGUMENT autonomously through the speckit stages, when you start mark the issue to in-progress using the label in-progress, update the github issue with comments when you start and finish each
...
10. `/speckit.implement` - Execute all tasks to implement the feature, use tdd make surew you use the terraform-provider-design skill, resolve issues independently, validate all tests passing, validate all examples passing, documentation generated. Create PR and provider summary
11.
