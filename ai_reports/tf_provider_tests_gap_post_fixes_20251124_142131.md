...
## Executive Summary
- **251** modern state checks (`statecheck.ExpectKnownValue`)
- **43** modern plan checks (`plancheck.Expect*`)
...
- **47/99** optional fields are tested
...
- **Test functions:** 19
- **Modern state checks:** 53
- **Modern plan checks:** 12
- **Has import test:** ✅
- **Has drift test:** ✅
