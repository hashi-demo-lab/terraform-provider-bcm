...
- **56/111** optional fields are tested
...
- **`cmpart_softwareimage`**: kernel_output_console, revision_id, file_operation_in_progress, parent_software_image
