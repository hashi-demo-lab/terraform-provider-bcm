...
## Codebase Statistics
**Total Go Files:** 39 files | 23,227 lines
- Code: 17,766 lines (76%)
- Comments: 3,149 lines (13%)
- Blank: 2,312 lines (9%)

**By File Type:**
| Type | Files | Lines | Code Lines |
|------|------:|------:|-----------:|
| Test | 22 | 13,367 | 10,418 |
| Resource | 5 | 5,435 | 4,215 |
| Data Source | 7 | 3,004 | 2,404 |
| Other | 5 | 1,421 | 729 |
| **Total** | **39** | **23,227** | **17,766** |

**Test-to-Implementation Ratio:** 1.42:1 (10,418 test lines / 7,348 impl lines)
